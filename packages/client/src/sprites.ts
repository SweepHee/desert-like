...
const LOOK: Record<string, { shape: string; pal: string; accent?: string }> = {
  ...
  c_rotting_corpse: { shape: 'soldier', pal: 'pandemonium', accent: '#7fb03a' },
  c_villager_child_m: { shape: 'soldier', pal: 'sylvarin', accent: '#d9c98a' },
  c_villager_child_f: { shape: 'soldier', pal: 'sylvarin', accent: '#d9c98a' },
  c_villager_adult_m: { shape: 'soldier', pal: 'sylvarin', accent: '#d9c98a' },
  c_villager_adult_f: { shape: 'soldier', pal: 'sylvarin', accent: '#d9c98a' },
  c_villager_elder_m: { shape: 'soldier', pal: 'sylvarin', accent: '#d9c98a' },
  c_villager_elder_f: { shape: 'soldier', pal: 'sylvarin', accent: '#d9c98a' },
  c_village_a: { shape: 'soldier', pal: 'sylvarin', accent: '#8fd08a' },
  c_village_b: { shape: 'soldier', pal: 'sylvarin', accent: '#8fd08a' },
  c_village_c: { shape: 'soldier', pal: 'sylvarin', accent: '#8fd08a' },
  c_village_d: { shape: 'soldier', pal: 'sylvarin', accent: '#8fd08a' },
  ...
  c_asha: { shape: 'soldier', pal: 'sylvarin' },
  c_asha_chaser: { shape: 'archer', pal: 'sylvarin' },
  c_asha_venom: { shape: 'mage', pal: 'sylvarin' },
  c_asha_butcher: { shape: 'soldier', pal: 'sylvarin' },
  c_asha_sniper: { shape: 'archer', pal: 'sylvarin' },
